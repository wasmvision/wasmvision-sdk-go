...
//go:wasmimport wasmvision:platform/datastore [method]frame-store.delete-all
//go:noescape
func wasmimport_FrameStoreDeleteAll(self0 uint32, frame0 uint32, result *cm.Result[DatastoreError, struct{}, DatastoreError])

//go:wasmimport wasmvision:platform/datastore [method]frame-store.exists
//go:noescape
func wasmimport_FrameStoreExists(self0 uint32, frame0 uint32, result *cm.Result[DatastoreError, bool, DatastoreError])
...
//go:noescape
func wasmimport_FrameStoreGetKeys(self0 uint32, frame0 uint32, result *cm.List[string])
...
//go:wasmimport wasmvision:platform/datastore [method]processor-store.delete-all
//go:noescape
func wasmimport_ProcessorStoreDeleteAll(self0 uint32, processor0 *uint8, processor1 uint32, result *cm.Result[DatastoreError, struct{}, DatastoreError])

//go:wasmimport wasmvision:platform/datastore [method]processor-store.exists
//go:noescape
func wasmimport_ProcessorStoreExists(self0 uint32, processor0 *uint8, processor1 uint32, result *cm.Result[DatastoreError, bool, DatastoreError])
...
//go:noescape
func wasmimport_ProcessorStoreGetKeys(self0 uint32, processor0 *uint8, processor1 uint32, result *cm.List[string])
