...
// Package keyvalue represents the imported interface "wasmvision:platform/key-value".
package keyvalue
...
// Store represents the imported resource "wasmvision:platform/key-value#store".
//
